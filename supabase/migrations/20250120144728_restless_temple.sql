/*
  # Update points calculation with step count bonus

  1. Changes
    - Add step_count column to daily_logs if it doesn't exist
    - Update points calculation function to include step count bonus
    - Recreate trigger with updated function

  2. Points System
    - Workout (30+ min): 5 points for first 5 workouts, 10 points for 6th and 7th
    - Sleep (7+ hours): 5 points
    - Screen time (under 5 hours): 5 points
    - No sugar: 4 points
    - Steps (12K+): 5 points
*/
